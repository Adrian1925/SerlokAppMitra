...
import 'incoming_order_detail_terima.dart';
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "Durasi 8 hari",
                  style: TextStyle(
                      fontSize: 20, color: AppColors.red.withOpacity(0.8)),
                ),
              ],
            ),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const DetailOrderTerimaPage(),
                      ),
                    );
                  },
                  child: Container(
